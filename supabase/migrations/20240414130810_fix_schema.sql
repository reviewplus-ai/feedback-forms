...
CREATE INDEX idx_review_forms_user_id ON public.review_forms(user_id);
CREATE INDEX idx_review_forms_company_id ON public.review_forms(company_id);
CREATE INDEX idx_review_forms_slug ON public.review_forms(slug);
